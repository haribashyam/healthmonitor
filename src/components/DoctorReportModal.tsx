  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 overflow-y-auto print:bg-white print:p-0 print:m-0 print:static print:overflow-visible font-mono">
      ...
      <div
        className={`w-full max-w-4xl border-2 transition-all my-4 relative ${
          previewTheme === 'paper'
            ...
            : 'bg-[#111111] text-[#F9F9F7] border-[#333333]'
      ...
      >
        ...
        <div className="p-4 sm:p-5 border-b border-[#333333] bg-[#141414] text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 print:hidden">
          <div className="flex items-center gap-3">
            <div className="p-2 border border-[#444444] bg-[#1E1E1E] text-white">
              <Stethoscope className="w-5 h-5" />
            </div>
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base sm:text-lg font-serif font-black uppercase tracking-tight text-white">
              ...
              <p className="text-xs font-mono text-[#AAAAAA] mt-0.5">
          ...
          <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto justify-end text-xs font-mono">
            {onOpenWorkspace && (
              <>
                <button
                  ...
                  className="px-3 py-1.5 font-bold uppercase bg-[#222222] hover:bg-[#333333] text-white border border-[#444444] flex items-center gap-1.5 transition-all"
            ...
            <button
              ...
              className="px-3 py-1.5 font-bold uppercase bg-[#1C1C1C] text-[#DDDDDD] hover:text-white hover:bg-[#2A2A2A] border border-[#444444] flex items-center gap-1.5 transition-all"
            >
            ...
            <button
              onClick={handlePrint}
              className="px-4 py-1.5 font-bold uppercase bg-white text-[#111111] hover:bg-[#EAEAEA] border border-white flex items-center gap-1.5 transition-all"
            >
            ...
            <button
              onClick={onClose}
              className="p-1.5 text-zinc-400 hover:text-white text-base hover:bg-zinc-800 transition-all ml-1 border border-zinc-700"
        ...
        {showOptions && (
          <div className="p-4 sm:p-5 bg-[#141414] border-b border-[#333333] space-y-4 print:hidden text-xs font-mono text-[#DDDDDD]">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[#888888] text-[11px]">Preview Mode:</span>
                <button
                  onClick={() => setPreviewTheme('dark')}
                  className={`px-2 py-0.5 font-bold uppercase ${
                    previewTheme === 'dark' ? 'bg-white text-black' : 'bg-[#222222] text-[#888888]'
                  }`}
                >
                  Dark UI
                </button>
                <button
                  ...
                  className={`px-2 py-0.5 font-bold uppercase ${
                    previewTheme === 'paper' ? 'bg-white text-black font-black' : 'bg-[#222222] text-[#888888]'
                  }`}
                >
                  Paper Preview
                </button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                <label className="text-[10px] text-[#888888] uppercase font-bold block mb-1">Patient Name</label>
                <input
                  type="text"
                  value={patientName}
                  onChange={(e) => setPatientName(e.target.value)}
                  className="w-full bg-[#1C1C1C] border border-[#333333] px-2.5 py-1 text-white focus:outline-none focus:border-white text-xs"
                />
              </div>
              <div>
                <label className="text-[10px] text-[#888888] uppercase font-bold block mb-1">DOB / Age</label>
                <input
                  type="text"
                  value={patientDob}
              ...
              <div>
                <label className="text-[10px] text-[#888888] uppercase font-bold block mb-1">Attending Physician / Clinic</label>
                <input
                  type="text"
                  value={physicianName}
            ...
            <div>
              <label className="text-[10px] text-[#888888] uppercase font-bold block mb-1">
              ...
              <textarea
                ...
                rows={2}
                className="w-full bg-[#1C1C1C] border border-[#333333] px-2.5 py-1.5 text-white focus:outline-none focus:border-white text-xs"
                placeholder="Type specific questions or symptoms to discuss with your doctor..."
              />
            </div>

            <div className="pt-2 border-t border-[#333333]">
              <span className="text-[10px] text-[#888888] uppercase font-bold block mb-2">Include in Generated PDF:</span>
